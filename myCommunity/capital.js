            ...
            $.each(data.dataList,function(index,val){
                ...
                $(".wrapper>.tab>li>a").click(function(){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {
                            itemId: sessionStorage.getItem('itemId'),functionId: sessionStorage.getItem('kindsId'),cateId: sessionStorage.getItem('cateId')
                        },
                        success: function(data){
                            console.log(data);
                            if(index==0){
                            ...
                            if(index==1){
                                ...
                                $.each(data.dataList,function
                                    ...
                                    $(".products>.main>.past").click(function(){
                                        ...
                                        sessionStorage.setItem('textData',textData);
                                        console.log(textData);
                                        window.location.href = 'publicity.html';
                            ...
                            if(index==2){
                                ...
                                $.ajax({
                                    type: 'get',
                                    url: 'http://59.152.38.197:8188/SmartHotelInterface/api/community/listPublicityFunds?requestUser=sxbctv&requestPassword=123456',
                                    dataType: 'json',
                                    success: function(data){
                                        console.log(data);
                                        $.each(data.dataList,function(index,val){
                                            $(".products>.main").append('<div class="past" name="'+val.kindsId +'"><h4>'+val.title+'</h4><div class="time">捐款钱数：'+val.money+'</div></div>');
                                            // $('.products>.main>.past').click(function(){
                                            //     window.location.href="text.html"
                                            // })
                                        })
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        itemId: sessionStorage.getItem('itemId'),functionId: sessionStorage.getItem('kindsId'),cateId:cateId
                    },
                    success: function(data){
                        //console.log(data);
                        console.log(data);
