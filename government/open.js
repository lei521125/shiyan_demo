            ...
            $.each(data.dataList,function(index,val){
                ...
                $('.wrapper>.tab>li>a').on('click',function() {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {itemId: sessionStorage.getItem('itemId'), functionId: sessionStorage.getItem("kindsCateId"),cateId: sessionStorage.getItem("cateId") },
                        success: function(data){
                            console.log(data);
                                $(".products>.main").html('')
                ...
                $.ajax({
                    ...
                    url: 'http://59.152.38.197:8188/HiSuOpenAPI/api/pubInterface/kinds?requestUser=sxbctv&requestPassword=123456',
                    dataType: "json",
                    data: {itemId: sessionStorage.getItem('itemId'), functionId: sessionStorage.getItem("kindsCateId"),cateId: cateId},
                    success: function(data){
                        console.log(data);
                        $(".products>.main").html('')
                        $.each(data.dataList,function
